...
Thereby, [QC Atlas](/user-guide/qc-atlas/) builds the basic knowledge base. The different additional features of [NISQ Analyzer](/user-guide/nisq-analyzer/), [Pattern Atlas](/user-guide/qc-atlas/pattern-relation-type/), and [QProv](/user-guide/qprov/) are supported on top of the QC Atlas and are defined as feature sets.  
...
The base components [QC Atlas](/user-guide/qc-atlas/), QC Atlas UI, [LaTeX Renderer](/user-guide/qc-atlas/latex-renderer/), Config-Server, and the databases without any of the named features run by default using:
